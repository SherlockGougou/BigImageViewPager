...
object GlobalContext {
     ...
     * @param cacheDataSourceFactory 视频缓存数据源工厂（可选，ExoPlayer 不可用时为 null）
     */
    @MainThread
    @Synchronized
    fun init(app: Application, cacheDataSourceFactory: Any?) {
    ...
    /**
     * 获取视频缓存数据源工厂
     * @return 缓存数据源工厂，如果 ExoPlayer 不可用则返回 null
     */
