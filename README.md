...
# 此处显示的是本框架的最新版本号：
#### 对于glide4.x : 使用v4_2.0.0
#### 对于glide3.x : 使用v3_2.0.0
...
dependencies {
  ...
  // 主库，必须添加！
  implementation 'com.github.SherlockGougou:BigImageViewPager:v4_2.0.0'
  // v7支持库，必须添加！
...
============================分割线==================================
  ...
  implementation 'com.github.SherlockGougou:BigImageViewPager:v3_2.0.0'
  implementation 'com.android.support:appcompat-v7:27.1.1'
}
```
