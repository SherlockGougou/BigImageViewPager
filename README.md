...
##### 此处显示的是本框架的最新版本号：
```
对于glide4.x : 使用 v4_3.0.2
对于glide3.x : 使用 v3_3.0.2
```
...
dependencies {
  ...
  // 主库，必须添加！
  implementation 'com.github.SherlockGougou:BigImageViewPager:v4_3.0.2'
  // v7支持库，必须添加！
...
================================v4/v3分割线==================================
  ...
  implementation 'com.github.SherlockGougou:BigImageViewPager:v3_3.0.2'
  implementation 'com.android.support:appcompat-v7:27.1.1'
}
```
