...
##### 此处显示的是本框架的最新版本号：
```
对于glide4.x : 使用 v4_2.2.2
对于glide3.x : 使用 v3_2.2.2
```
```
dependencies {
  ...
  // 主库，必须添加！
  implementation 'com.github.SherlockGougou:BigImageViewPager:v4_2.2.2'
  // v7支持库，必须添加！
...
================================分割线==================================
  ...
  implementation 'com.github.SherlockGougou:BigImageViewPager:v3_2.2.2'
  implementation 'com.android.support:appcompat-v7:27.1.1'
}
```
